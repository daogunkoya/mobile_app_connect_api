...
class StoreFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'moderation_status' => 1,
            'store_status' => 1,
            'store_user_email' => 'df@mail.com',
            'store_name' => "test",
            'store_user_password' =>  "test",
            'store_group_revenue_id' =>  "test",
            'store_group_industry_id' =>  "test",
            'store_business_name' =>  "test",
            'store_business_type_id' =>  "test",
            'store_business_vat' =>  "test",
            'store_business_crn' =>  "test",
            'store_user_first_name' => "test",
            'store_user_last_name' =>  "test",
            'store_user_address' =>  "test",
            'store_user_postcode' => "test",
            'store_user_city' => "test",
            'store_user_dob' =>  "test",
