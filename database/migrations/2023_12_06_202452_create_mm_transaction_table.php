...
class CreateMmTransactionTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('mm_transaction', function (Blueprint $table) {
            ...
            $table->double('total_commission')->default(0.0)->nullable();
            $table->double('agent_commission')->default(0.0)->nullable();
            $table->double('exchange_rate')->default(0.0)->nullable();;
            $table->double('bou_rate')->default(0.0)->nullable();
            $table->double('sold_rate')->default(0.0)->nullable();
