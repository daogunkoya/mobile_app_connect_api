...
.hero_area {
  position: relative;
  min-height: 100vh;
  background: linear-gradient(130deg, #231a6f, #0f054c); /* Deep blue gradient */
}
...
.overlay {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(255, 255, 255, 0.8); /* Light gray overlay */
  z-index: 0;
}
      ...
      <section class="layout_padding">
        <div class="container">
          ...
          <div class="content">
            ...
            <p>
              Thank you for using <strong>MoneyApp</strong> (the "App" or
              "Service"). Your privacy is important to us. This Privacy Policy
              explains how we collect, use, disclose, and protect your
              information when you use our App and services. By using MoneyApp,
            ...
            <ul>
              <li>
                ...
                phone number, government-issued identification, and payment
                information.
              </li>
              <li>
                <strong>Usage Data:</strong> Transaction details, currency
                exchange requests, and interaction with features.
              </li>
              <li>
              ...
              <li>
                ...
                your IP address or GPS (if enabled).
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>Opt-out of marketing communications or data collection.</li>
            </ul>
            <p>
            ...
            <p>
              <strong>admin@monytransfer.com </strong>  <br />
