...
function fetch_custom_deals_byCategory($content, $connect_row, $limit)
{
    ...
    $fetch_categories = bd_item_deal::join('bd_item_connect', 'bd_item_connect.item_id', '=', 'bd_item_deal.id_item')
                              ...
                              ->where('bd_item_connect.row_number', '>', $connect_row ?? 0)
                              ->select(
                                  'bd_item_deal.created_at as time_ago',
                                  'bd_item_deal.id_item AS item_id',
                                  'bd_item_deal.item_type',
                                  'bd_item_deal.item_code',
                                  'bd_item_deal.item_url',
                                  'bd_item_deal.item_title',
                                  'bd_item_deal.item_slug',
                                  'bd_item_deal.list_image as item_image',
                                  'bd_item_deal.item_price_sale',
                                  'bd_item_deal.item_price_compare',
                                  'bd_item_deal.list_group as item_group',
                                  'bd_item_deal.item_rate',
                                  'bd_item_deal.item_rate_overall',
...
function fetch_custom_discussionss_byCategory($content, $connect_row, $limit)
{
    ...
    $fetch_categories = bd_item_discussion::join('bd_item_connect', 'bd_item_connect.item_id', '=', 'bd_item_discussion.id_item')
                               ...
                               ->where('bd_item_connect.row_number', '>', $connect_row ?? 0)
                               ->select(
                                   'bd_item_discussion.created_at as time_ago',
                                   'bd_item_discussion.id_item AS item_id',
                                   'bd_item_discussion.item_title',
                                   'bd_item_discussion.item_slug',
                                   'bd_item_discussion.item_content',
                                   'bd_item_discussion.list_image as item_image',
                                   'bd_item_discussion.list_group as item_group',
                                   'bd_item_discussion.item_rate',
                                   'bd_item_discussion.item_rate_overall',
