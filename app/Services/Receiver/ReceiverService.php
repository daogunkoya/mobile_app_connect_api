...
class ReceiverService{
    ...
    //fetch receiver
    public  function fetchReceiver($request,$sender_id){
       ...
       // $user_id = "2bda0c37-4eac-44e5-a014-6c029d76dc62";
        ...
        $query = receiver::where('user_id', $user_id)->where('sender_id', $sender_id)->where('receiver_name', 'like', $search)->orderBy('created_at', 'DESC');
        $count  =  $query->count();
        ...
        // $receiver_query = receiver::where('sender_id', $sender_id);
    ...
    //create new receiver
    public  function createReceiver($input, $sender_id){
    ...
    //updatereceiver
    public  function updateReceiver($input,  $receiver_id){
