...
class RateService
{
    ...
    public function storeRate($input, $rate_model)
    {
    ...
    public function updateRate($rate_id, $input, $rate_model)
    {
    ...
    public function fetchRateList($input, $rate_model, $currency_model, $user_model)
    {
    ...
    public function fetchRate($rate_id, $rate_model, $currency_model, $user_model)
    {
    ...
    public function deleteRate($rate_id, $rate_model)
    {
