...
class mm_transaction extends Model
{
            ...
            public static function boot()
            {
                ...
                self::creating(function ($model) {
                    $model->id_transaction = (string) Uuid::generate(4);
            ...
            public function getSenderNameAttribute($transaction_id){
                $fname = mm_transaction::where('id_transaction', $transaction_id)->value('sender_fname');
                $lname = mm_transaction::where('id_transaction', $transaction_id)->value('sender_lname');
                return $fname.' '. $lname;
            }

            public function getReceiverNameAttribute($transaction_id){
                
                $fname = mm_transaction::where('id_transaction', $transaction_id)->value('receiver_fname');
                $lname = mm_transaction::where('id_transaction', $transaction_id)->value('receiver_lname');
                return $fname.' '. $lname;
            }
            ...
            public function setReceiverIdentityTypeIdAttribute($name_value){
               ...
               return mm_bank::where('name_bank', $name_value)->value('id_bank');
            }
