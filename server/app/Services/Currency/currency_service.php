...
class currency_service{
    ...
    public function store_currency($input, $currency_model){
    ...
    public function update_currency($currency_id, $input, $currency_model){
    ...
    public function fetch_currency_list( $input, $currency_model){
    ...
    public function fetch_currency($currency_id,  $currency_model){
        $select = [ 'user_id','currency_origin', 'currency_origin_symbol','currency_destination', 'currency_destination_symbol','currency_code','income_category',];
    ...
    public function delete_currency($currency_id, $currency_model){
